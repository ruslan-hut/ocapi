...
type Product struct {
	...
	DateAvailable  primitive.DateTime `json:"date_available,omitempty" bson:"date_available" validate:"omitempty"`
	...
	DateAdded      primitive.DateTime `json:"date_added,omitempty" bson:"date_added" validate:"omitempty"`
	DateModified   primitive.DateTime `json:"date_modified,omitempty" bson:"date_modified" validate:"omitempty"`
